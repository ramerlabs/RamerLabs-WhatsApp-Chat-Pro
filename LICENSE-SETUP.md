...
On **plugins.ramerlabs.com**, the product is auto-seeded on License Manager activation/upgrade:
...
4. Activation hits `plugins.ramerlabs.com/wp-json/ramerlabs-license/v1/activate`
